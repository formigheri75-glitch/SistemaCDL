...
const messages = {
  ...
  detalhesDesafio: {
    ...
    description:
      "Desenvolver soluções tecnológicas para aprimorar o ensino híbrido, incluindo plataformas de aprendizado adaptativo, ferramentas de colaboração remota e sistemas de avaliação.",
    ...
    notifications: [
      {
        ...
        description:
          "Desenvolver assistentes virtuais para personalização do ensino",
      },
      {
      ...
      },
      {
        ...
        description:
          "Evento amanhã às 10h — participe para esclarecer critérios de avaliação",
      },
      {
  ...
  criaProblema: {
    ...
    tecnologiasPlaceholder:
      "Ex: React, Node.js, PostgreSQL (separadas por vírgula)",
  ...
  home: {
    ...
    cadastroEmpresa: {
      ...
      description:
        "Registre sua empresa na plataforma e comece a criar desafios.",
    },
    cadastroInstituicao: {
    ...
    criaProblema: {
      title: "Criar Problema",
      description:
        "Publique um novo desafio e receba propostas das instituições.",
    },
    detalhesProblema: {
    ...
    detalhesProposta: {
      ...
      description:
        "Analise propostas em detalhes com plano completo de implementação.",
    },
    desafios: {
      title: "Desafios",
  ...
  criaProblema: {
    ...
    tecnologiasPlaceholder:
      "Ex: Node.js, React, PostgreSQL (separadas por vírgula)",
  ...
  detalhesProposta: {
    ...
    voltar: "Voltar",
    sucesso:
      "Proposta aceita com sucesso! A equipe da instituição entrará em contato em breve.",
  },
